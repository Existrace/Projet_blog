                    ...
                    <div class="card-content center">
                        ...
                        <div class="row">
                            <div class="col m6 s12" style="padding: 20px">
                                <a class="link_stylised" href="/comment/moderatecomments"> Modérer les commentaires</a>
                            </div>
                            <div class="col m6 s12" style="padding: 20px">
                                <a class="link_stylised" href="/post/create"> Création d'un nouvel article</a>
                            </div>
                        </div>
                                        ...
                                        <div class="col m12 s12 l12">
                                            <div class="card black-text">
                                                <div class="card-content">
                                                    ...
                                                    <hr/>
                                                    <a
                                                       href="/post/update/<?= $post->getId() ?>"> Modifier</a>
                                                    |
                                                    <a
